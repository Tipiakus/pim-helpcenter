...
Par exemple, vous pouvez lier un produit à ses accessoires. Le code pour ce type d'association sera "ACCESSOIRES".

Les types d'association sont obligatoires pour créer des liens entre deux produits. Il n'y a pas de type d'association par défaut.
...
1.  Renseignez le code du type d'association que vous voulez créer
1.  Confirmez

Le type d'association est créé et la page de modification s'affiche.  
...
Les modifications apportées aux types d'association sont enregistrées et visibles sous l'onglet `Historique` du type d'association.
